...
export function useDriverFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDriverFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.driver.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDriverCount<T extends Prisma.driverCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.driverCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useDriverCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.driver.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDriverFindManyWithCount<
  T extends Prisma.driverFindManyArgs,
  R extends { data: GetFindResult<Prisma.$driverPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.driverFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDriverFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.driver.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDriverFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDriverFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.driver.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
