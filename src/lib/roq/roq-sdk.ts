...
import type { Prisma, booking, car, company, customer_service_representative, driver, user } from './types';
...
interface DriverSDK {
  create: <T extends Prisma.driverCreateArgs, R extends CheckSelect<T, driver, Prisma.driverGetPayload<T>>>(
    data: Prisma.SelectSubset<T, Prisma.driverCreateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  createMany: <T extends Prisma.driverCreateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.driverCreateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  update: <T extends Prisma.driverUpdateArgs, R extends Prisma.driverGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.driverUpdateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  updateMany: <T extends Prisma.driverUpdateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.driverUpdateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  upsert: <T extends Prisma.driverUpsertArgs, R extends Prisma.driverGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.driverUpsertArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  delete: <T extends Prisma.driverDeleteArgs, R extends Prisma.driverGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.driverDeleteArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  deleteMany: <T extends Prisma.driverDeleteManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.driverDeleteManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  findMany: <T extends Prisma.driverFindManyArgs, R extends GetFindResult<Prisma.$driverPayload<DefaultArgs>, T>[]>(
    args: Prisma.SelectSubset<T, Prisma.driverFindManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  count: <T extends Prisma.driverCountArgs, R extends number>(
    args: Prisma.SelectSubset<T, Prisma.driverCountArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  findManyWithCount: <
    T extends Prisma.driverFindManyArgs,
    R extends GetFindResult<Prisma.$driverPayload<DefaultArgs>, T>[],
    C extends number,
  >(
    args: Prisma.SelectSubset<T, Prisma.driverFindManyArgs>,
    options?: RequestOptions,
  ...
  findFirst: <T extends Prisma.driverFindFirstArgs, R extends GetFindResult<Prisma.$driverPayload<DefaultArgs>, T>>(
    args?: Prisma.SelectSubset<T, Prisma.driverFindFirstArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
}
...
export class RoqClient extends RoqPlatformClient {
  ...
  private initSDK() {
    ...
    this.driver = {
      create: async function createDriver<
        T extends Prisma.driverCreateArgs,
        R extends CheckSelect<T, driver, Prisma.driverGetPayload<T>>,
      >(data: Prisma.SelectSubset<T, Prisma.driverCreateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/driver/create`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      createMany: async function createManyDriver<T extends Prisma.driverCreateManyArgs, R extends Prisma.BatchPayload>(
        data: Prisma.SelectSubset<T, Prisma.driverCreateManyArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/driver/createMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      update: async function updateDriver<T extends Prisma.driverUpdateArgs, R extends Prisma.driverGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.driverUpdateArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/driver/update`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      updateMany: async function updateManyDriver<T extends Prisma.driverUpdateManyArgs, R extends Prisma.BatchPayload>(
        data: Prisma.SelectSubset<T, Prisma.driverUpdateManyArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/driver/updateMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      upsert: async function upsertDriver<T extends Prisma.driverUpsertArgs, R extends Prisma.driverGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.driverUpsertArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/driver/upsert`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      delete: async function deleteDriver<T extends Prisma.driverDeleteArgs, R extends Prisma.driverGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.driverDeleteArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/driver/delete`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, true>(
          reqUrl,
          {
      ...
      deleteMany: async function deleteManyDriver<T extends Prisma.driverDeleteManyArgs, R extends Prisma.BatchPayload>(
        data: Prisma.SelectSubset<T, Prisma.driverDeleteManyArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/driver/deleteMany`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, false>(
          reqUrl,
          {
      ...
      findMany: async function findManyDriver<
        T extends Prisma.driverFindManyArgs,
        R extends GetFindResult<Prisma.$driverPayload<DefaultArgs>, T>[],
      >(args: Prisma.SelectSubset<T, Prisma.driverFindManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/driver/findMany`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      count: async function countDriver<T extends Prisma.driverCountArgs, R extends number>(
        args: Prisma.SelectSubset<T, Prisma.driverCountArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/driver/count`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      findManyWithCount: async function findManyWithCountDriver<
        T extends Prisma.driverFindManyArgs,
        R extends GetFindResult<Prisma.$driverPayload<DefaultArgs>, T>[],
        C extends number,
      >(args: Prisma.SelectSubset<T, Prisma.driverFindManyArgs>, options?: RequestOptions) {
        const { distinct, orderBy, where } = args || {};
        const [data, count] = await Promise.all([
          ctx.driver.findMany(args, options),
          ctx.driver.count(
            {
              distinct,
              orderBy,
      ...
      findFirst: async function findFirstDriver<
        T extends Prisma.driverFindFirstArgs,
        R extends GetFindResult<Prisma.$driverPayload<DefaultArgs>, T>,
      >(args?: Prisma.SelectSubset<T, Prisma.driverFindFirstArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/driver/findFirst`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
