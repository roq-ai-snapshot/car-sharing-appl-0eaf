...
import { useDriverFindFirst, useRoqClient } from 'lib/roq';
...
function DriverViewPage() {
  ...
  const { data, error, isLoading } = useDriverFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  ...
                  text={data?.license_expiry_date ? format(data?.license_expiry_date, 'dd-MM-yyyy') : ''}
                />
