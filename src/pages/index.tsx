  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock a world of convenience with Car Sharing Application - Your key to seamless and efficient car sharing experiences."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock a world of convenience with Car Sharing Application - Your key to seamless and efficient car sharing experiences.`}
            </Text>
            <Box
