...
import {
  ...
  useDriverCount,
  useCarCount,
  useCustomerServiceRepresentativeCount,
} from 'lib/roq';

import { DriverListPage as ShowCaseList } from 'pages/drivers';

function DashboardPage() {
  const { session } = useSession();

  const driverStat = useDriverCount();
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`drivers`} passHref legacyBehavior>
                  <Button
